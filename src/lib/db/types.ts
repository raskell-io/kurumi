...
// SM-2 algorithm fields stored per card. Cards are extracted from
// notes (Q: ... A: ... syntax) or generated by the LLM.
// ---------------------------------------------------------------------------

export interface Flashcard {
	id: string;
	memoryObjectId: string | null; // source note, null for standalone
	question: string;
	answer: string;
